...
> Org health: stale PRs, bus factor, hot paths

**Author:** zAx4hub

## Problem

Teams need a practical open toolkit for: **Org health: stale PRs, bus factor, hot paths**. Existing options are often closed SaaS or untested prototypes.

## Solution

`repo-radar` is a complete, installable TypeScript/Node project by **zAx4hub** with real algorithms, CLI/demos, tests, and CI.
